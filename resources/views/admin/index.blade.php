	...
	<div class="row">
		...
		<div class="col-3">
			<div class="card">
				...
				<div class="card-body">
					<p><strong>Tổng số loại: </strong>{{ $loai['sum'] }}</p>
					<p><strong>Số loại đã xóa: </strong>{{ $loai['del'] }}</p>
					<p><strong>Loại thêm gần đây: </strong> {{ $loai['last'] }}</p>
					<a href="{{ route('indexAdminLoai') }}" class="btn btn-secondary">Quản lí loại</a></div>
				</div>
		</div>
		...
		<div class="col-3">
			<div class="card">
				...
				<div class="card-body">
					<p><strong>Tổng số nhà sản xuất: </strong>{{ $nhasanxuat['sum'] }}</p>
					<p><strong>Các nhà sản xuất đã xóa: </strong>{{ $nhasanxuat['del'] }}</p>
					<p><strong>Nhà sản xuất thêm gần đây: </strong>{{ $nhasanxuat['last'] }}</p>
